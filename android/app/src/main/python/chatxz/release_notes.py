...
RELEASE_NOTES = {
    ...
    "1.0.0": [
        ...
        "Call buttons in chat header: voice, video, and screen share. Everything routes through encrypted RNS links.",
        "Legacy voice notes and pyaudio removed — calls are real-time duplex, not file attachments.",
    ],
    "0.5.13": [
